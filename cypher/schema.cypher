// Schema for the Framewise evidence graph
// TwelveLabs (Marengo + Pegasus) -> Neo4j graph
//
...
CREATE CONSTRAINT generation_theme_id_unique IF NOT EXISTS FOR (n:GenerationTheme) REQUIRE n.id IS UNIQUE;
CREATE CONSTRAINT rough_cut_id_unique IF NOT EXISTS FOR (n:RoughCut) REQUIRE n.id IS UNIQUE;
...
CREATE INDEX generation_theme_key IF NOT EXISTS FOR (n:GenerationTheme) ON (n.key);
