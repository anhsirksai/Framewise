/**
 * Domain configuration for Framewise
 */
...
export const DOMAIN = {
  ...
  name: "Framewise",
  description:
    "Turn every video into reusable intelligence. TwelveLabs extracts what is shown, said, and written per segment; Neo4j merges the same entities across videos.",
  tagline: "Video is evidence. The graph makes it reusable.",
};
